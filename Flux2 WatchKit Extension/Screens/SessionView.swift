                ...
                ForEach(0..<2) {sessions in
                    VStack{
                        ForEach(0..<3) { number in
                            NavigationLink(destination: TimerView(totalCycles: Int(pow(cycles, Double(number))), session: sessionTypes[sessions] * 60, completedSessionTime: sessionTypes[sessions])) {
